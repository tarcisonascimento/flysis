...
idmac int primary key auto_increment not null,
datamacro timestamp default current_timestamp,
iduso int not null,
foreign key(iduso) references usuarios(iduso),
idcli int not null,
foreign key(idcli) references clientes(idcli),
-- abaixo sao os parametros hemodinâmicos
mvo2 	varchar (5) default '00,00', -- volume maximo de oxigenio
mdebcard varchar(7) default '00,00', -- debito cardiaco
mabs varchar (4) default '00', -- quantidade de abdominais
mflex varchar (4), -- quantidade de flexoes de braço
magacha varchar (4), -- quantidade de agachamentos
-- abaixo sao os parametros neuromusculares
mvelocidade varchar (5) default '0', -- velocidade de deslocamento
mfoexpms varchar (5) default '0,0', -- força exlosiva de membros superiores
mfoexpmi varchar (5) default '0,0',	-- força exlosiva de membro sinferiores
mcapala varchar (5) default '0000', -- capacidade anaerobica alatica
mflexibi varchar (5) default '0' -- felexibilidade
);
...
carlac03 varchar (15), -- classifica lactato
...
postu21 varchar (5) default 0, -- alcance banco de wells
postu22 varchar (25) default 'Não calculado',
neuro28 varchar (8), -- distancia calculo de velocidade
neuro29 varchar (5), -- tempo para percorrer a distancia
neuro30 varchar (5) default '0' -- velocidade de deslocamento em km/h
